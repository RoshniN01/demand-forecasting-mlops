...
MLflow was used to track the model training experiments, hyperparameters, and evaluation metrics such as RMSE and MAPE.

![MLflow Dashboard](images/mlflow1.jpeg)

![MLflow Run Comparison](images/mlflow2.jpeg)

![MLflow Metrics](images/mlflow3.jpeg)

### Optuna Hyperparameter Optimization

Optuna was used to optimize the LightGBM hyperparameters. Multiple trials were performed using different parameter configurations, and the trial RMSE values were compared to identify better-performing configurations.
...
Prometheus was used to collect monitoring metrics exposed by the MLflow exporter. The monitored metrics include:
...
![Prometheus Monitoring](images/Promotheus_Metrics.png)

### Grafana Dashboard

Grafana was used to visualize the monitoring metrics collected from the demand forecasting MLOps pipeline. The dashboard provides a centralized view of model and pipeline performance.

![Grafana Dashboard](images/Grafana%20Dashboard.jpeg)

### ZenML Pipeline

ZenML was used to orchestrate the different stages of the demand forecasting workflow, including feature engineering, model training, forecasting, and evaluation.
